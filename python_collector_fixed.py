...
class GitKrakenAutomator:
    ...
    def process_batch_with_gitkraken(self, batch_num, total_batches):
        ...
        try:
            ...
            commit_message = f"D: Python files batch {batch_num}/{total_batches} auto-added"
            subprocess.run([
                "gk", "work", "commit", "-m", commit_message
            ], check=True, capture_output=True, text=True, 
               encoding='utf-8', errors='ignore', env=env)
            ...
            try:
                subprocess.run(["git", "add", "."], check=True, 
                             encoding='utf-8', errors='ignore')
                subprocess.run(["git", "commit", "-m", f"Batch {batch_num} auto-added"], 
    ...
    def generate_report(self):
        ...
        with open(report_path, 'w', encoding='utf-8') as f:
            ...
            for i, file_info in enumerate(self.python_files[:20], 1):
