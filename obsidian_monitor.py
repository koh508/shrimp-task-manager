...
class ObsidianScreenMonitor:
    ...
    def detect_changes_histogram(self, current_image: np.ndarray) -> float:
        ...
        try:
            ...
            # 히스토그램 계산
            hist1 = cv2.calcHist([self.last_screenshot], [0, 1, 2], None, [8, 8, 8], [0, 256, 0, 256, 0, 256])
            hist2 = cv2.calcHist([current_image], [0, 1, 2], None, [8, 8, 8], [0, 256, 0, 256, 0, 256])
